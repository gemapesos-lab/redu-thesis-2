...
Philippine background materials show that doomscrolling and digital well-being had already entered local public discourse by 2021 #cite(<panaligan-2021>, form: "prose") #cite(<lanuza-2021>, form: "prose").
...
#cite(<sharma-2022>, form: "prose") establish doomscrolling as a measurable self-report construct, while #cite(<satici-2023>, form: "prose") extend that psychometric work and support a shorter 4-item form. Together, these studies justify using self-reported doomscrolling as a baseline convergent-association anchor rather than as session-level ground truth.
...
#cite(<zannettou-2024>, form: "prose") show that engagement with TikTok recommendation streams can be studied from donated behavioral traces, while #cite(<lokeshkumar-2021>, form: "prose") show that text and activity patterns can be processed computationally as risk-relevant indicators. These studies serve as methodological analogies that support the technical plausibility of trace-based behavioral analysis.
...
#cite(<punzalan-2024>, form: "prose") provide the closest local study to the present topic by describing doomscrolling-related experiences among Filipino students. #cite(<bautista-2024>, form: "prose"), #cite(<canila-2023>, form: "prose"), #cite(<ababat-2024>, form: "prose"), and #cite(<cleofas-2022>, form: "prose") reinforce the same local signal: heavier or more problematic social media use is linked to boredom proneness, distraction, procrastination, attention-related strain, or poorer mental well-being among Filipino students and young adults. These studies establish Philippine relevance but remain student-centered, self-report-heavy, or qualitative, supporting cautious adult field evaluation.

=== Social Media, Reading Competence, and Attention Span

#cite(<gagalang-2021>, form: "prose") and #cite(<cardoso-2024>, form: "prose") together support the local relevance of attention-related harms associated with heavy digital-platform use, especially among students. They help explain why viewing cadence and sustained use are reasonable behavioral dimensions to observe.

=== Cognitive Benefits of Digital Detox Interventions

#cite(<lim-2025>, form: "prose") show that a two-week digital detox can improve attention and memory among Filipino Grade 12 students. The study is relevant because it makes a two-week observation window plausible.
...
Software evaluation is anchored on the official ISO/IEC 25010 product quality model #cite(<iso-25010-2023>). The standard supports the choice of selected quality characteristics, while the survey wording used in Chapter 3 is researcher-developed and subject to expert review.
